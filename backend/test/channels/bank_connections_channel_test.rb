...
# O painel de sync (RF21) ouve este canal. Escopado por workspace_id: só
# membros do workspace assinam; o broadcast carrega a conexão atualizada.
class BankConnectionsChannelTest < ActionCable::Channel::TestCase
  setup do
    @user      = create(:user)
