...
function tx(o: Partial<InboxTransaction> = {}): InboxTransaction {
  return {
    ...
    account_kind: 'credit_card', institution_label: 'Nubank', account_institution_name: 'Nubank', account_brand: null, account_last_digits: null, card_last_digits: null,
    installment_number: null, installment_total: null, installment_group_id: null, purchase_date: null, foreign_currency: null,
...
describe('<RefundSection />', () => {
  ...
  it('shows the effective amount and unlink for a refunded debit', async () => {
    ...
    expect(screen.queryByTestId('refund-auto-badge')).not.toBeInTheDocument()
    const user = userEvent.setup()
  ...
  // RF10.6 — estorno vinculado automaticamente pelo código.
