...
Rails.application.configure do
  ...
  # …mas o shell do SPA (index.html/sw.js/manifest) precisa revalidar sempre,
  # senão o navegador trava numa versão antiga (ver StaticCacheControl).
  ...
  config.action_mailer.default_url_options = { host: "wallet.portilho.cc" }
  ...
  # localhost, então não passa por config.hosts.
