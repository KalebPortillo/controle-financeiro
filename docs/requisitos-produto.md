...
- **RF10.6** **Auto-vínculo de estorno por heurística de confiança**: ao chegar um estorno (só créditos que **parecem estorno**: "estorno/crédito de/IOF de volta/reembolso"), o sistema procura o gasto original numa janela de datas e classifica a confiança:
  - **Alta** — o **nome/código** do estorno bate um **único** gasto (só existe um gasto com aquele nome, ou o código é único): vincula **mesmo com valor diferente** (estorno parcial, Nike, Amazon-código). Se o nome casa vários, o **valor exato** desempata.
